  ...
  var _default = _exports.default = {
    vxe: {
      ...
      error: {
        ...
        modelConflicts: 'Существует конфликт между граничным значением поля "{0}" и "{1}", и возникнет ошибка',
        ...
        noGroup: '«{0}» не поддерживается после группировки данных',
      ...
      table: {
        ...
        impSuccess: '{0} записи были успешно импортированы',
        expLoading: 'Экспорт',
        ...
        maxGroupCol: 'Количество максимальных полей группировки не может превышать {0}',
        dragTip: 'MOVE: {0}',
      ...
      select: {
        ...
        emptyText: 'Нет данных пока',
        maxSize: 'Максимальное количество параметров не может превышать {0}',
      ...
      export: {
        types: {
          csv: 'CSV (раздел для запятой) (*. CSV)',
          html: 'Веб -страница (*.html)',
          xml: 'Данные XML (*.xml)',
          txt: 'Текстовый файл (вкладка-разделен) (*. Txt)',
      ...
      dateRangePicker: {
        pleaseRange: 'Пожалуйста, выберите дату начала и дату окончания'
      },
      input: {
        date: {
          m1: 'Январь',
      ...
      upload: {
        ...
        manualUpload: 'Нажмите, чтобы загрузить',
      ...
      formDesign: {
        ...
        widgetProp: {
          ...
          dataSource: {
            ...
            buildOption: 'Генерировать параметры'
          },
          rowProp: {
      ...
      plugins: {
        extendCellArea: {
          area: {
            ...
            multiErr: 'Эта операция не может быть выполнена в области многопользования',
            selectErr: 'Невозможно управлять ячейками в указанной области',
            extendErr: 'Если расширенная область содержит объединенные ячейки, все объединенные ячейки должны быть одинакового размера',
            pasteMultiErr: 'Невозможно вставить, необходимо скопировать и вставить области того же размера, чтобы сделать это',
            cpInvalidErr: 'Эта операция не может быть выполнена, в выбранной вами области есть запрещенные столбцы ({0})'
          },
          fnr: {
            ...
            replaceSuccess: '{0} ячейки были успешно заменены'
          }
        },
        extendPivotTable: {
          aggregation: {
        ...
        filterComplexInput: {
          menus: {
            ...
            fixedGroup: 'Заморозить группировку',
            cancelFixed: 'Отменить замораживание',
            fixedLeft: 'Заморозить левую сторону',
