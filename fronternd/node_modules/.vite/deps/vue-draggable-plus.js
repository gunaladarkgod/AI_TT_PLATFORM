...
var $t = function(e, n) {
  var o = h2(e), r = parseInt(o.width) - parseInt(o.paddingLeft) - parseInt(o.paddingRight) - parseInt(o.borderLeftWidth) - parseInt(o.borderRightWidth), i = we(e, 0, n), a = we(e, 1, n), l = i && h2(i), s = a && h2(a), u = l && parseInt(l.marginLeft) + parseInt(l.marginRight) + M(i).width, d = s && parseInt(s.marginLeft) + parseInt(s.marginRight) + M(a).width;
  if (o.display === "flex")
  ...
  _onTouchMove: function(e) {
    if (de) {
      ...
      if (g) {
        ...
        h2(g, "webkitTransform", m), h2(g, "mozTransform", m), h2(g, "msTransform", m), h2(g, "transform", m), Ze = d, Qe = f, J = i;
      }
  ...
  _showClone: function(e) {
    ...
    if (se) {
      if (G("showClone", this), p.eventCanceled)
        return;
      c.parentNode == C && !this.options.group.revertClone ? C.insertBefore(O, c) : pe ? C.insertBefore(O, pe) : C.appendChild(O), this.options.group.revertClone && this.animate(c, O), h2(O, "display", ""), se = false;
    }
  }
};
function jn(t) {
...
var rt = Gt(function(t, e, n, o) {
  if (e.scroll) {
    ...
    var f = 0, m = Se;
    do {
      var y = m, b = M(y), E = b.top, k = b.bottom, H = b.left, F = b.right, A = b.width, L = b.height, ne = void 0, j = void 0, Q = y.scrollWidth, v = y.scrollHeight, w = h2(y), x = y.scrollLeft, N = y.scrollTop;
...
var so = {
  [Xt.mounted](t, e) {
    const n = isProxy(e.value) ? [e.value] : e.value, [o, r] = n, i = tn(t, o, r);
    it.set(t, i.destroy);
  },
  [Xt.unmounted](t) {
    var e;
