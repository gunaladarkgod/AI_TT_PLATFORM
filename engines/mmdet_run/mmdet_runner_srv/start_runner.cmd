...
if defined APP_WORKSPACE_ROOT (
  set "REPO_ROOT=%APP_WORKSPACE_ROOT%"
) else (
...
if not defined MMDET_REPO_ROOT set "MMDET_REPO_ROOT=%REPO_ROOT%\engines\mmdet_run\mmdetection-3.0.0"
if not defined MMDET_UPLOAD_ROOT set "MMDET_UPLOAD_ROOT=%REPO_ROOT%\engines\mmdet_run\myfiles"
